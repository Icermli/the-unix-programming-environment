...
void parse(s, pfrom1, pto1, pcmd, pfrom2, pto2)
    char *s;
...
void nskip(fin, n) /* skip n lines of file fin */
    FILE *fin;
    int n;
{
  char buf[BUFSIZ];
...
void ncopy(fin, n, fout) /* copy n lines of from fin to fout */
    FILE *fin, *fout;
    int n;
{
  char buf[BUFSIZ];
